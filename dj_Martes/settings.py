"""
Django settings for dj_Martes project.
...
SECRET_KEY = 'django-insecure-q_)bl*o82qd0_qg=qs2kebc!=7v-tn8g3nag+!v=zv%wx4kvj6'
...
WSGI_APPLICATION = 'dj_Martes.wsgi.application'
